    ...
    public partial class MainForm : Form
    {
        ...
        void ViewPortMouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            if (dialogProcessor.Selection != null)
            {
                ...
                {
                    m_contextMenu.Show(MousePosition.X, MousePosition.Y);
                }
            }
            //}
        }
        ...
        private void onOptionColorClicked(object sender, EventArgs e)
        {

            if (m_colorDialog.ShowDialog() == DialogResult.OK)
                dialogProcessor.Selection.FillColor = m_colorDialog.Color;
        }
